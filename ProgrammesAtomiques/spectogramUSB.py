...
def spectrogram(RXLO = int(430e6), RXFS=int(30e6), samples = 200, fft_size = 32768, affichage = False):
    ...
    if affichage :
        plt.imshow(rx_samples, aspect='auto', extent=[0, samples, RXLO -RXFS/2,RXLO + RXFS/2,])
...
a = spectrogram(RXLO = int(895e6), RXFS=int(30e6), samples = 500, fft_size = 32768, affichage = True)
print()
