...
def spectrogram(RXLO = int(600e6), RXFS=int(30e6), samples = 500, fft_size = 32768, affichage = True):
...
# print(max_freq(RXLO = int(430e6), RXFS=int(30e6), samples = 200, fft_size = 32768, affichage = True))
